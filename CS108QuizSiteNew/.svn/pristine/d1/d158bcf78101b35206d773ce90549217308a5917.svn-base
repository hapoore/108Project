			...
			<div class="col-xs-8">
				...
				<h1>Administrator Actions</h1>
					...
					<form action="ClearQuizServlet" method="post">
						<p>Clear quiz history: Need quiz name and author's username</p>
						<div class="form-group">
					...
					<p>Remove quiz: Need quiz name and author's username</p>
						<div class="form-group">
							<label for="quizToRemove">Quiz name</label> <input type="text"
