...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-4">
				<div class="well">
				<h3>Please enter your new status.</h3>
					<form action="UpdateStatusServlet" method="post">
						<div class="form-group">
							<label for="Status">Profile Picture</label> <input type="text"
								class="form-control" name="Status" maxlength="160" placeholder="Status">
						</div>
