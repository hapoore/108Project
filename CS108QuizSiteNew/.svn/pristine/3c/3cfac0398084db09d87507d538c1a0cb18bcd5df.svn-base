...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-4">
				<div class="well">
				<h3>Please enter a link to your new profile picture.</h3>
					<form action="ChangeProfilePictureServlet" method="post">
						<div class="form-group">
							<label for="username">Profile Picture</label> <input type="text"
								class="form-control" name="profPic" maxlength="64" placeholder="Profile Picture">
						</div>
