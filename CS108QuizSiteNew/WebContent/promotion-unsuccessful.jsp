...
<title>Promotion Unsuccessful</title>
...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-8">
				<div class="well">
				<h1>Your promotion was unsuccessful. The username you entered does not exist.</h1>
				<a class="btn btn-success" href="admin-home.jsp">Return to administrator home</a>
				</div>
			</div>
			<div class="col-xs-2"></div>
		</div>
